...
public class ShotsAdapter extends CursorAdapter {
	...
	private BitmapDrawable mDefaultAvatarBitmap = (BitmapDrawable) Driibo
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		holder.imageRequest = RequestManager.loadImage(shot.getImage_url(),
				RequestManager.getImageListener(holder.image,
						mDefaultImageDrawable, mDefaultImageDrawable));
		holder.avartarRequest = RequestManager.loadImage(shot.getPlayer()
				.getAvatar_url(), RequestManager.getImageListener(
		...
		holder.text_comment_count.setText(String.valueOf(shot
				.getComments_count()));
